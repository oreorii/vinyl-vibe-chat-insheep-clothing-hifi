...
system_message = {
    ...
    "Limit the response to 300 words, unless user specifically ask for long answers")
}
...
def chat():
        ...
        append_relevant_articles(flattened_keywords, articles, messages_with_articles)
    
        print(f"LOG: acticles added as context: {len(messages_with_articles)-original_message_length}")
